...
const StudentForm: React.FC<StudentFormProps> = ({ newStudent, setNewStudent, handleAddStudent }) => {
  return (
    <div className="bg-white/80 backdrop-blur-md shadow-xl rounded-lg p-4 border border-slate-200">
      <h3 className="text-xl mb-4 text-gray-900 font-bold text-right">הוספת תלמיד</h3>
      <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
        <div className="md:col-span-2">
          <Input 
            ...
            className="bg-white text-gray-900 placeholder:text-gray-500 border-slate-300 focus-visible:ring-offset-slate-100 text-right"
          />
        </div>
        <div>
          <Input 
