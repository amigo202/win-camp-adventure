...
const GuideNavigation: React.FC = () => {
  ...
  return (
    <div 
      className="relative overflow-hidden text-white py-6 px-8 flex justify-between items-center rounded-xl mb-6 shadow-lg border border-white/10 bg-white/10 backdrop-blur-sm"
      style={{ 
    ...
    >
      ...
      <div className="text-2xl font-bold relative z-10 flex items-center">
        ...
        <NavigationMenuList className="gap-4">
          <NavigationMenuItem>
            <Button 
              variant="outline" 
              size="lg"
              className="bg-white/20 text-white border-white/30 hover:bg-white/30 hover:text-white text-lg font-bold shadow-md backdrop-blur-sm px-6 py-3 rounded-xl transition-all hover:scale-105"
